...
const editWordID=async (req,res)=>{
    const {id:wordID}=req.params;
    const bod=req.body;
...
const deleteWordID=async (req,res)=>{
    const {id:wordID}=req.params;
    try{
...
const oneWordName=async (req,res)=>{
...
const editWordName=async (req,res)=>{
...
const deleteWordName=async (req,res)=>{
    let {name:wordName}=req.params;
    wordName=wordName.toLowerCase();
    try{
